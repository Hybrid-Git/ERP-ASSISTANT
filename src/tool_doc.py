...
TOOL_INTENT_REGISTRY = {
    ...
    "get_outstanding_sales_invoices": {
        ...
        "prompt_tips": "from_date/to_date YYYY-MM-DD, sort_by=daysOverdue|invoiceDate|outstanding, sort_order=asc|desc. Summary row (recordType=outstandingSalesInvoices, name=Summary) has totalInvoices, totalOutstanding, totalOverdue, totalCurrent. Filter by agingBucket=Current|30_60|60_90|90_plus, or ledgerName contains keyword.",
        "aliases": [
        ...
        "field_aliases": {
            ...
            "ledgerName": ["customer", "customer name", "party", "ledger", "ledger name"],
            "country": ["country"],
            "state": ["state"],
            ...
            "taxableAmount": ["taxable amount", "taxable"],
            "outstanding": ["outstanding", "pending", "due amount", "balance", "remaining"],
    ...
    "get_outstanding_purchase_invoices": {
        ...
        "prompt_tips": "from_date/to_date YYYY-MM-DD, sort_by=daysOverdue|invoiceDate|outstanding, sort_order=asc|desc. Summary row (recordType=outstandingPurchaseInvoices, name=Summary) has totalInvoices, totalOutstanding, totalOverdue, totalCurrent. Filter by agingBucket=Current|30_60|60_90|90_plus, or ledgerName contains keyword.",
        "aliases": [
        ...
        "field_aliases": {
            "recordType": ["record type"],
            "invoiceId": ["invoice id"],
            "invoiceNo": ["invoice no", "invoice number", "invoice", "bill no", "bill number"],
            "invoiceDate": ["invoice date", "date", "bill date"],
            "dueDate": ["due date", "due"],
            "ledgerId": ["vendor id", "supplier id", "ledger id"],
            "ledgerName": ["vendor", "vendor name", "supplier", "supplier name", "ledger", "ledger name"],
            "country": ["country"],
            "state": ["state"],
            "txModeType": ["transaction type", "tx type", "mode"],
            "invoiceType": ["invoice type", "type"],
            ...
            "taxableAmount": ["taxable amount", "taxable"],
            "outstanding": ["outstanding", "pending", "due amount", "balance", "remaining", "payable"],
            "paidAmount": ["paid amount", "paid", "payment"],
            "daysOverdue": ["days overdue", "overdue days", "days", "delay"],
            "isOverdue": ["is overdue", "overdue"],
            "agingBucket": ["aging bucket", "bucket", "aging", "current", "30-60", "60-90", "90+"],
    ...
    "get_overdue_invoices": {
        ...
        "prompt_tips": "invoice_type=SALES|PURCHASE|BOTH, as_of_date YYYY-MM-DD, sort_by=daysOverdue|invoiceDate|outstanding, sort_order=asc|desc. Default invoice_type=BOTH. Filter by invoiceCategory=RECEIVABLE|PAYABLE to separate sales vs purchase. Summary row (recordType=overdueInvoices, name=Summary) has totalInvoices, totalOverdue, totalReceivables, totalPayables, receivablesCount, payablesCount.",
        "aliases": [
        ...
        "field_aliases": {
            "recordType": ["record type"],
            "invoiceId": ["invoice id"],
            "invoiceNo": ["invoice no", "invoice number", "invoice", "bill no"],
            "invoiceDate": ["invoice date", "date", "bill date"],
            "dueDate": ["due date", "due"],
            "ledgerId": ["customer id", "vendor id", "ledger id"],
            "ledgerName": ["customer", "customer name", "vendor", "vendor name", "party", "ledger", "ledger name"],
            "country": ["country"],
            "txModeType": ["transaction type", "tx type", "mode"],
        ...
        "repair": {
            "overwrite": False,
            "default_fields": ["invoiceNo", "invoiceDate", "dueDate", "ledgerName", "invoiceCategory", "netAmount", "outstanding", "daysOverdue", "agingBucket"],
            "param_aliases": {"type": "invoice_type"},
        },
    },
}
